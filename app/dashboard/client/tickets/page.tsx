        ...
        <div className="w-full p-6 lg:p-8">
            <div className="mb-6 flex flex-col gap-4 p-1 lg:flex-row lg:items-center lg:justify-between">
                ...
                <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-sm bg-tertiary px-4 py-2.5 text-sm font-bold text-on-primary transition hover:bg-primary-container/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                >
                    <Plus size={18} />
                    Nouveau ticket
                </Link>
