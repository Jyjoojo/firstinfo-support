    ...
    <CategoriesPageTransition>
      ...
      <div className="mb-7 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-2xl font-bold text-on-surface">Catégorie des tickets</h1>
          <p className="mt-1 text-base text-on-surface-variant">Visualisez les catégories utilisées pour qualifier les demandes de support.</p>
        </div>
