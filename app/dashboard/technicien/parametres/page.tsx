            ...
            <div className="flex flex-wrap items-center mb-5 gap-6 md:gap-10 bg-surface-container-lowest py-6 ps-10 rounded-xl border border-outline-variant/20">
                ...
                <div className="flex-1">
                    <h3 className="text-lg font-medium mb-1 flex items-center gap-1.5">
                        Christophe KABRAN <BadgeCheck size={16} className="text-green-600 shrink-0" />
                    </h3>
                    <p className="text-sm text-on-surface-variant mb-1">Responsable Equipe Support</p>
                ...
                <div className="flex-1 flex-wrap items-center md:gap-10 mb-5 bg-surface-container-lowest py-6 ps-10 pe-6 rounded-xl border border-outline-variant/20">
                                ...
                                <DialogContent className="sm:max-w-md" onInteractOutside={(e) => e.preventDefault()}>
                                    ...
                                    <FieldGroup>
                                        <Field>
                                            ...
                                            <Input id="nom" name="nom" defaultValue="KABRAN" className="focus-visible:ring-primary-container" />
                                        </Field>
                                        <Field>
                                            <Label htmlFor="prenoms">Prénoms</Label>
                                            <Input id="prenoms" name="prenoms" defaultValue="Ange Christophe" className="focus-visible:ring-primary-container" />
                                        </Field>
                                        <Field>
                                            <Label htmlFor="email">Email</Label>
                                            <Input id="email" name="email" type="email" defaultValue="angekabran@gmail.com" className="focus-visible:ring-primary-container" />
                                        </Field>
                                        <Field>
                    ...
                    <div className="mb-6 grid w-full grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-[15px] font-medium">KABRAN</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            <p className="text-sm text-on-surface-variant mb-1">Prénoms</p>
                            <p className="text-[15px] font-medium">Ange Christophe</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            <p className="text-sm text-on-surface-variant mb-1">Email adresse</p>
                            <p className="text-[15px] font-medium">angekabran@firstinfoci.com</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            <p className="text-sm text-on-surface-variant mb-1">Contact</p>
                            <p className="text-[15px] font-medium">(+225) 01 02 47 18 20</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            <p className="text-sm text-on-surface-variant mb-1">Rôle</p>
                            <p className="text-[15px] font-medium">Technicien</p>
                        </div>
                    </div>
                </div>
