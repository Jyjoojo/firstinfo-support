            ...
            <div>
                <div className="max-w-sm mx-auto w-full">
                    <div className="flex flex-col items-center mb-5 text-center">
                        <h1 className="text-3xl font-bold text-on-surface mb-2">Bienvenu(e) !</h1>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            type="button"
                            className="flex items-center justify-center gap-2 border border-outline-variant/40 rounded-lg py-2.5 text-sm font-medium text-on-surface hover:bg-surface-container-low transition-colors"
                        >
                            <GoogleIcon />
                            Google
                        </button>
                    ...
                    <p className="text-center text-sm text-on-surface-variant mt-6 mb-10">
